...
<a href="http://help.west.cn/help/list.asp?unid=432" target="_blank" style="color:red">独立服务器自动发送邮件配置说明！</a>
 ...
 <tr>
    ...
    <tr>
        <td align="right" nowrap class="tdbg">短信接口邮局域名：</td>
      <td class="tdbg"><input name="sms_mailname" type="text" id="sms_mailname" value="<%=sms_mailname%>">
          <br>
          系统支持西部数码的短信接口。这里填入在西部数码的企业邮局的名称，使用前需要先给该邮局充值短信条数。</td>
    </tr>
    <tr>
        <td align="right" nowrap class="tdbg">短信接口域名密码：</td>
      <td class="tdbg"><input name="sms_mailpwd" type="text" id="sms_mailpwd" value="<%=sms_mailpwd%>">
          填入在西部数码的企业邮局的管理密码。</td>
    </tr>
    <tr>
