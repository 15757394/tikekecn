  ...
  <!--
   ...
   $(function(){
		...
		$("form[name='formpay']").submit(function(){
			...
			if(iswestpay &&  (paytype=="defaultpay" || paytype=="defaultpaywx" || paytype=="defaultpayjd"))
			{	
   ...
   function showwestpay(money,paytype,titlestr){
		...
		var postdata="westact=getpayinfo&payMoney="+money+"&paytype="+paytype
		...
		<tr>
			<td>
			 <div class="Pay_type">
				...
				<dl>
				   <dt><input type="radio" name="paytype" value="defaultpay" <%=checked%> id="pay_defaultpay"><label for="pay_defaultpay"><img src="onlineImg/2.gif" width="96" height="37" alt="默认支付接口" title="默认支付接口" /><span>手续费:<%=returnbfb(defaultpay_fy)%>%</span></label>
				   </dt>
				</dl>
				<%
				end if
				if iswestpay then%>
					<dl>
					   <dt><input type="radio" name="paytype" value="defaultpaywx"  <%=checked%> id="pay_defaultpaywx"><label for="pay_defaultpaywx"><img src="onlineImg/weixin.png" width="96" height="37" alt="默认支付接口" title="默认支付接口" /><span>手续费:<%=returnbfb(defaultpay_fy)%>%</span></label>
					   </dt>
					</dl>
					<dl>
					   <dt><input type="radio" name="paytype" value="defaultpay"   id="pay_defaultpay"><label for="pay_defaultpay"><img src="onlineImg/2.gif" width="96" height="37" alt="z支付接口" title="默认支付接口" /><span>手续费:<%=returnbfb(defaultpay_fy)%>%</span></label>
					   </dt>
					</dl>
					<!--
					<dl>
					   <dt><input type="radio" name="paytype" value="defaultpayjd"   id="pay_defaultpayjd"><label for="pay_defaultpayjd"><img src="onlineImg/jd.gif" width="96" height="37" alt="京东支付接口" title="京东支付接口" /><span>手续费:<%=returnbfb(defaultpay_fy)%>%</span></label>
					   </dt>
					</dl>
					-->
				<%end if%>
