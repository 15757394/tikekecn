...
<%
'defaultpay,tenpay,yeepay,alipay,kuaiqian
alertbox=""
onlinepayEnd="http://"& requesta("HTTP_HOST") & "/manager/onlinePay/onlinePayEnd.asp"
...
<tr>
  <td align="center" nowrap="nowrap" class="tdbg">  <%=alertbox%>
    </td>
</tr>
<tr>
  <td class="tdbg"><table width="100%" border="0" cellspacing="0" cellpadding="4">
  	  <tr>
      	<td colspan=2 align="center" nowrap="nowrap"><img border=0 src="<%=payImg%>"></td>
      </tr>
      <tr>
      	<td nowrap="nowrap">&nbsp;</td>
        <td nowrap="nowrap"><%=payName%></td>
      </tr>
      <tr>
      	<td nowrap="nowrap">&nbsp;</td>
        <td nowrap="nowrap"><%=payContent%></td>
      </tr>
      <tr>
          <td width="37%" align="right">用户名:</td>
          <td width="63%"><%=session("user_name")%></td>
      </tr>
      <tr>
          <td align="right">支付序号:</td>
          <td><%=payOrderID%></td>
      </tr>
      <tr>
          <td align="right">汇款金额:</td>
          <td><%=formatNumber(showMoney,2,-1,-1)%>￥</td>
      </tr>
      <tr>
          <td align="right">手续费:</td>
          <td><%=FormatNumber((showMoney * pay_fy),2,-1,-1)%>￥</td>
      </tr>
      <tr>
          <td align="right">最终金额:</td>
          <td><%=payMoney%>￥</td>
      </tr>
    </table></td>
</tr>
<tr>
  ...
  <input type="button" value="返回修改" onclick="javascript:history.back();">
  <%=postinput%> 
